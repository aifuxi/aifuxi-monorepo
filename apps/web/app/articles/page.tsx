...
const ArticlesPage = () => {
  return (
    <div className="grid grid-cols-2 gap-x-24">
      <div>
        <header className="flex justify-between items-center border-b pb-12">
      ...
      <div className="bg-black/5 max-h-[calc(100vh-128px)] sticky inset-y-[64px] featured-post-clip"></div>
    </div>
  );
};
